...
var author$project$LightingTools$initialModel = {address: 0, title: 'Lighting Tools'};
...
var author$project$LightingTools$init = _Utils_Tuple2(author$project$LightingTools$initialModel, elm$core$Platform$Cmd$none);
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$LightingTools$subscriptions = function (model) {
	return elm$core$Platform$Sub$none;
};
var elm$core$Basics$not = _Basics_not;
var author$project$DipSwitchCalc$validAddress = function (value) {
	return !((value > 512) || (value < 0));
};
var author$project$LightingTools$update = F2(
	function (msg, model) {
		var value = msg.a;
		return author$project$DipSwitchCalc$validAddress(value) ? _Utils_Tuple2(
			_Utils_update(
				model,
				{address: value}),
			elm$core$Platform$Cmd$none) : _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
	});
var author$project$DipSwitchCalc$Binary = function (a) {
	return {$: 'Binary', a: a};
};
var author$project$DipSwitchCalc$Bit = function (a) {
	return {$: 'Bit', a: a};
};
...
var author$project$DipSwitchCalc$addDummyBits = F2(
	function (size, bits) {
		return _Utils_ap(
			A2(
				elm$core$List$repeat,
				size - elm$core$List$length(bits),
				author$project$DipSwitchCalc$Bit(false)),
			bits);
	});
var elm$core$Basics$modBy = _Basics_modBy;
var author$project$DipSwitchCalc$divideIntoBits = F2(
	function (num, bits) {
		divideIntoBits:
		while (true) {
			if (!num) {
				...
				var $temp$num = (num / 2) | 0,
					$temp$bits = A2(
					elm$core$List$cons,
					A2(elm$core$Basics$modBy, 2, num),
					bits);
				num = $temp$num;
				bits = $temp$bits;
				continue divideIntoBits;
			}
		}
	});
var author$project$DipSwitchCalc$numToBit = function (num) {
	if (num === 1) {
		return author$project$DipSwitchCalc$Bit(true);
	} else {
		return author$project$DipSwitchCalc$Bit(false);
	}
};
...
var author$project$DipSwitchCalc$convertIntToBinary = function (num) {
	return author$project$DipSwitchCalc$Binary(
		A2(
			author$project$DipSwitchCalc$addDummyBits,
			10,
			A2(
				elm$core$List$map,
				author$project$DipSwitchCalc$numToBit,
				A2(author$project$DipSwitchCalc$divideIntoBits, num, _List_Nil))));
};
...
var author$project$DipSwitchCalc$green = A3(mdgriffith$elm_ui$Element$rgb255, 0, 170, 30);
var author$project$DipSwitchCalc$grey = A3(mdgriffith$elm_ui$Element$rgb255, 125, 125, 125);
var author$project$DipSwitchCalc$red = A3(mdgriffith$elm_ui$Element$rgb255, 255, 0, 0);
...
var author$project$DipSwitchCalc$bitIcon = function (on) {
		...
		[
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$Background$color(author$project$DipSwitchCalc$grey),
	...
	var _switch = on ? list : elm$core$List$reverse(list);
	var _n0 = on ? _Utils_Tuple2(author$project$DipSwitchCalc$green, mdgriffith$elm_ui$Element$alignTop) : _Utils_Tuple2(author$project$DipSwitchCalc$red, mdgriffith$elm_ui$Element$alignBottom);
	var color = _n0.a;
	var alignment = _n0.b;
	return A2(
...
var author$project$DipSwitchCalc$unwrapBit = function (bit) {
	var value = bit.a;
	return value;
};
...
var author$project$DipSwitchCalc$dipView = F3(
	function (msg, ix, bit) {
		return function (value) {
			return A2(
				...
				_List_Nil,
				{
					checked: author$project$DipSwitchCalc$unwrapBit(bit),
					icon: author$project$DipSwitchCalc$bitIcon,
					label: A2(
...
var author$project$DipSwitchCalc$bitToInt = function (bit) {
	return author$project$DipSwitchCalc$unwrapBit(bit) ? 1 : 0;
};
var author$project$DipSwitchCalc$unwrapBinary = function (binary) {
	var bits = binary.a;
	return bits;
};
var author$project$DipSwitchCalc$convertBinaryToInt = function (binary) {
	return A3(
		elm$core$List$foldl,
		F2(
			function (bit, sum) {
		...
		A2(
			elm$core$List$map,
			author$project$DipSwitchCalc$bitToInt,
			author$project$DipSwitchCalc$unwrapBinary(binary)));
};
...
var author$project$DipSwitchCalc$updateInIndex = F3(
	function (ix, a, list) {
		var tail = A2(elm$core$List$drop, ix + 1, list);
		var head = A2(elm$core$List$take, ix, list);
		return _Utils_ap(
			head,
			_Utils_ap(
				_List_fromArray(
...
var author$project$DipSwitchCalc$updateBinary = F3(
	function (ix, bit, binary) {
		return author$project$DipSwitchCalc$convertBinaryToInt(
			author$project$DipSwitchCalc$Binary(
				A3(
					author$project$DipSwitchCalc$updateInIndex,
					ix,
					bit,
					author$project$DipSwitchCalc$unwrapBinary(binary))));
	});
var author$project$DipSwitchCalc$mapBinaryMessage = F2(
	function (f, binary) {
		return F2(
			function (ix, value) {
				return f(
					A3(
						author$project$DipSwitchCalc$updateBinary,
						ix,
						author$project$DipSwitchCalc$Bit(value),
						binary));
			});
	});
...
var author$project$DipSwitchCalc$dipSwitchView = F2(
	function (msg, address) {
		var mappedMessage = A2(
			author$project$DipSwitchCalc$mapBinaryMessage,
			msg,
			author$project$DipSwitchCalc$convertIntToBinary(address));
		return A2(
			...
			A2(
				...
				elm$core$List$reverse(
					A2(
						elm$core$List$indexedMap,
						author$project$DipSwitchCalc$dipView(mappedMessage),
						author$project$DipSwitchCalc$unwrapBinary(
							author$project$DipSwitchCalc$convertIntToBinary(address))))));
	});
var elm$core$String$toInt = _String_toInt;
var author$project$DipSwitchCalc$mapInputMessage = function (msg) {
	return function (str) {
		return msg(
			A2(
				elm$core$Maybe$withDefault,
...
var author$project$DipSwitchCalc$numericAttributes = _List_fromArray(
	[
...
var author$project$DipSwitchCalc$numberView = F2(
	function (msg, num) {
		var inputText = (num < 0) ? '' : elm$core$String$fromInt(num);
		return A2(
			mdgriffith$elm_ui$Element$Input$text,
			_Utils_ap(_List_Nil, author$project$DipSwitchCalc$numericAttributes),
			{
				label: mdgriffith$elm_ui$Element$Input$labelHidden('DMX Address'),
				onChange: author$project$DipSwitchCalc$mapInputMessage(msg),
				placeholder: elm$core$Maybe$Nothing,
				text: inputText
			});
	});
var author$project$DipSwitchCalc$dipSwitchCalc = F2(
	function (msg, address) {
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			_List_fromArray(
				[
					A2(author$project$DipSwitchCalc$dipSwitchView, msg, address),
					A2(author$project$DipSwitchCalc$numberView, msg, address)
				]));
	});
var author$project$LightingTools$AddressChanged = function (a) {
	return {$: 'AddressChanged', a: a};
};
...
var mdgriffith$elm_ui$Element$layout = mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var author$project$LightingTools$view = function (model) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					A2(author$project$DipSwitchCalc$dipSwitchCalc, author$project$LightingTools$AddressChanged, model.address)
				])));
};
...
var author$project$Main$main = elm$browser$Browser$document(
	{
		init: function (flags) {
			return author$project$LightingTools$init;
		},
		subscriptions: author$project$LightingTools$subscriptions,
		update: author$project$LightingTools$update,
		view: function (model) {
			return {
				body: _List_fromArray(
					[
						author$project$LightingTools$view(model)
					]),
				title: model.title
			};
		}
